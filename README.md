...
```sudo docker run -p 25565:25565 -e EULA="true" ghcr.io/thijmengthn/papermc```
...
## Project Pages
- [GitHub page](https://github.com/ghcr.io/thijmengthn/papermc-docker).
- [Docker Hub page](https://hub.docker.com/r/ghcr.io/thijmengthn/papermc).
